<template>
  <div class="note" :style ="note" style="height: 580px" top="-20"  >
    <!--<el-image :src="src" style="" >-->
    <el-form label-position="left" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
      <h2 class="title">用户登录</h2>
      <el-form-item style="text-align: center">
        <el-input style="size: 100px;width: 190px;" v-model="user.username" auto-complete="off" placeholder="账号"></el-input>
      </el-form-item>
      <el-form-item style="text-align: center">
        <el-input style="size: 100px;width: 190px;" type="password" v-model="user.password" auto-complete="off" placeholder="密码"></el-input>
      </el-form-item><br/><br/>
      <el-form style="text-align: center"  :inline="true">
          <!--<span ><i class="el-icon-success " style="color: #faab02">&nbsp;&nbsp;已同意相关法律信息</i></span>-->
        <span ><el-checkbox :checked="true" >已同意相关法律信息</el-checkbox></span>
      </el-form>
      <br/>
      <el-form  :inline="true" style="text-align: center">
        <el-button style="width:120px;height: 40px " type="primary"  @click="AppMain"  >登陆</el-button>
        <el-button style="width:120px;height: 40px " type="success"   >重置</el-button>
        </el-form>
      <el-form-item style="text-align: center;">
        <el-link :underline="false" type="prmary" @click="register" >快速注册</el-link>&nbsp;&nbsp;&nbsp;<el-link :underline="false"type="prmary">忘记密码</el-link>
      </el-form-item>
    </el-form>
    <!--</el-image>-->
  </div>
